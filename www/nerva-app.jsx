...
// ════════════════════════════════════════════════════════════════════════════
// MATH SHEET (Layer 3 — opt-in, power users)
// ════════════════════════════════════════════════════════════════════════════
function PhaseSpace({ result, c }) {
  const W = 310, H = 240, Ml = 32, Mr = 12, Mt = 12, Mb = 24;
  ...
  return (
    <div style={{ minHeight: '100dvh', background: T.bg, color: T.ink, fontFamily: T.sans, display: 'flex', flexDirection: 'column', overscrollBehavior: 'contain' }}>
      ...
      {view === 'compose'
        ...
        : <CheckpointView text={text} cid={cid} onReset={reset} onMath={() => setMathOpen(true)} onAdjust={() => setAdjustOpen(true)} verdictStyle={t.verdict} texture={t.texture} ticks={t.ticks} />}
      ...
      {mathOpen && (
        <BottomSheet onClose={() => setMathOpen(false)} zIndex={30}>
